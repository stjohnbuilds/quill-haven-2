...
chrome.runtime.onMessage.addListener(function (msg, sender, sendResponse) {
  ...
  var ALLOWED = ['/sleep', '/reboot', '/poweroff', '/wifi-settings', '/go-home', '/terminal', '/apply-update', '/screen-off', '/wifi-list', '/wifi-connect', '/wifi-toggle', '/wifi-disconnect', '/wifi-forget'];
